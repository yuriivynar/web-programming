...
function FilterSelect({ label, options, value, color, onFunction, onCountChange, onColorChange }) {
    ...
    return (
        <div className="filter_select">
            {location.pathname.startsWith('/catalog/') && (
                <div className="selected_line">
                    ...
                    <div className="selected_line_item">
                        ...
                        <select defaultValue={color} onChange={(e) => onColorChange(e.target.value)}>
                            {options.map((option) => (
            ...
            {location.pathname === '/catalog' && (
                <select value={value} onChange={onFunction}>
